            ...
            <div class="col-lg-12 ">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  Form Tambah Data Urusan
                </div>

                <div class="card-body">
                  
                  <?= form_open_multipart('admin/master/Urusan/add'); ?>
                   
                   <div class="form-group row">
                      <label for="name" class="col-sm-2 col-form-label">Nama Urusan</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Masukan nama Urusan" value="<?= set_value('name'); ?>">
