                    ...
                    <div class="col-xl-12">
                      <div class="card border-left shadow h-100 py-2">
                        <div class="card-body">
                          ...
                          <h5>  <?= $produk_hukum ?> <span class="text-white bg-danger"><strong> <?= set_value('keyword'); ?> </strong></span>: <?= $jumlah_data; ?> Peraturan<!-- <?= $total_rows; ?>  --></h5>
                          <div class="box-info">
                                ...
                                <div class="col-xl-8 col-md-6 mb-4">
                                  <div class="card  shadow h-100 py-2">
                                    <div class="card-body">
                                      ...
                                      <span class="text-xs btn-secondary"><i class="fas fa-gavel"></i> Ikhtisar Per BAB yang berkaitan</span>
